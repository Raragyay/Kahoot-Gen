...
class FrenchSynonymGenerator(QuestionGeneratorBase):
    def __init__(self):
        super().__init__()
        self.required_data_funcs = [list_of_french_sets, all_french_vocab_set]
        self.filter_funcs = [has_synonyms]
    ...
    async def generate_a_question(row: Series, *data, **kwargs) -> Question:
        ...
        return Question(chosen_french_term, chosen_answer, incorrect_answers)
